Profile:        JP_Composition_eMunicipalCheckup_561
Parent:         Composition
Id:             JP-Composition-eMunicipalCheckup-561
//Title:          "自治体検診結果報告書　Compositionリソース　文書構成情報"
Description:    "自治体検診結果報告書　Compositionリソース　文書構成情報(肝炎ウイルス一次)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Composition_eMunicipalCheckup_561"
* ^status = #draft
