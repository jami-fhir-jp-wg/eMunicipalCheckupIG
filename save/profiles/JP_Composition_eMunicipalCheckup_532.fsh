Profile:        JP_Composition_eMunicipalCheckup_532
Parent:         Composition
Id:             JP-Composition-eMunicipalCheckup-532
//Title:          "自治体検診結果報告書　Compositionリソース　文書構成情報"
Description:    "自治体検診結果報告書　Compositionリソース　文書構成情報(胃がん精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Composition_eMunicipalCheckup_532"
* ^status = #draft
