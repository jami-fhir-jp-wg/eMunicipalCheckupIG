Profile:        JP_Bundle_eMunicipalCheckup_532
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-532
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(胃がん精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_532"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_532
    * ^short = "文書構成情報(胃がん精密検査)"
