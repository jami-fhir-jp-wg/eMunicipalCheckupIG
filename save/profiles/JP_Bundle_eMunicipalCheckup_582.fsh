Profile:        JP_Bundle_eMunicipalCheckup_582
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-582
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(歯周疾患精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_582"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_582
    * ^short = "文書構成情報(歯周疾患精密検査)"
