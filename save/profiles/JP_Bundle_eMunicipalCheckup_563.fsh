Profile:        JP_Bundle_eMunicipalCheckup_563
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-563
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(肝炎ウイルス一次と精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_563"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_563
    * ^short = "文書構成情報(肝炎ウイルス一次と精密検査)"
...
* entry[9P616000000000011]
  * ^short = "検査結果情報エントリ 肝炎ウイルス検診の精密検査結果"
  * fullUrl 1..1 MS
    * ^short = "エントリリスト内のリソースを一意に識別するためのUUID。"
  * resource 1..1 MS
  * resource only JP_Observation_eMunicipalCheckup_9P616000000000011
    * ^short = "健診項目情報 肝炎ウイルス検診の精密検査結果"

* entry[9P617160800000049]
  * ^short = "検査結果情報エントリ 肝炎ウイルス検診の精密検査所見"
  * fullUrl 1..1 MS
    * ^short = "エントリリスト内のリソースを一意に識別するためのUUID。"
  * resource 1..1 MS
  * resource only JP_Observation_eMunicipalCheckup_9P617160800000049
    * ^short = "健診項目情報 肝炎ウイルス検診の精密検査所見"
