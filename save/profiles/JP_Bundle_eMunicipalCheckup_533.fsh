Profile:        JP_Bundle_eMunicipalCheckup_533
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-533
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(胃がん一次検診と精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_533"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_533
    * ^short = "文書構成情報(胃がん一次検診と精密検査)"
...
* entry[9P549000000000011]
  * ^short = "検査結果情報エントリ 胃がん検診の精密検査結果"
  * fullUrl 1..1 MS
    * ^short = "エントリリスト内のリソースを一意に識別するためのUUID。"
  * resource 1..1 MS
  * resource only JP_Observation_eMunicipalCheckup_9P549000000000011
    * ^short = "健診項目情報 胃がん検診の精密検査結果"

* entry[9P550160800000049]
  * ^short = "検査結果情報エントリ 胃がん検診の精密検査所見"
  * fullUrl 1..1 MS
    * ^short = "エントリリスト内のリソースを一意に識別するためのUUID。"
  * resource 1..1 MS
  * resource only JP_Observation_eMunicipalCheckup_9P550160800000049
    * ^short = "健診項目情報 胃がん検診の精密検査所見"

* entry[9P551000000000011]
  * ^short = "検査結果情報エントリ 胃がん検診の精密検査による偶発症の有無"
  * fullUrl 1..1 MS
    * ^short = "エントリリスト内のリソースを一意に識別するためのUUID。"
  * resource 1..1 MS
  * resource only JP_Observation_eMunicipalCheckup_9P551000000000011
    * ^short = "健診項目情報 胃がん検診の精密検査による偶発症の有無"
