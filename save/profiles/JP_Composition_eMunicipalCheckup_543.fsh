Profile:        JP_Composition_eMunicipalCheckup_543
Parent:         Composition
Id:             JP-Composition-eMunicipalCheckup-543
//Title:          "自治体検診結果報告書　Compositionリソース　文書構成情報"
Description:    "自治体検診結果報告書　Compositionリソース　文書構成情報(子宮頸がん一次検診と精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Composition_eMunicipalCheckup_543"
* ^status = #draft
...
//  * entry contains OBS 1..* MS and COV 0..2 MS
  ...
  * entry[9N291160700000011] only Reference(JP_Observation_eMunicipalCheckup_9N291160700000011)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診の視診所見有無 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9N296160700000011] only Reference(JP_Observation_eMunicipalCheckup_9N296160700000011)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診の内診所見有無 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[Group_7A021] only Reference(JP_Observation_eMunicipalCheckup_Group_7A021)
    * ^short = "検査結果セクションに含まれる 頸部細胞診検査 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[7A021000008543311] only Reference(JP_Observation_eMunicipalCheckup_7A021000008543311)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診の頸部細胞診検査判定 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[7A021160808543349] only Reference(JP_Observation_eMunicipalCheckup_7A021160808543349)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診の頸部細胞診検査所見 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9P562000000000011] only Reference(JP_Observation_eMunicipalCheckup_9P562000000000011)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診の精密検査の対象有無 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9P563160800000049] only Reference(JP_Observation_eMunicipalCheckup_9P563160800000049)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診のその他所見 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9P564000000000011] only Reference(JP_Observation_eMunicipalCheckup_9P564000000000011)
    * ^short = "検査結果セクションに含まれる 子宮頚がん検診による偶発症の有無 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9P565000000000011] only Reference(JP_Observation_eMunicipalCheckup_9P565000000000011)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診の精密検査結果 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9P566160800000049] only Reference(JP_Observation_eMunicipalCheckup_9P566160800000049)
    * ^short = "検査結果セクションに含まれる 子宮頸がん検診の精密検査所見 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9P567000000000011] only Reference(JP_Observation_eMunicipalCheckup_9P567000000000011)
    * ^short = "検査結果セクションに含まれる 子宮頚がん検診の精密検査による偶発症の有無 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
...
//  * entry only Reference(JP_Observation_eMunicipalCheckup_9P560000000000011 or JP_Observation_eMunicipalCheckup_9P561000000000011)
  ...
  * entry contains
    ...
    9P561000000000011 0..1 MS
  * entry[9P560000000000011] only Reference(JP_Observation_eMunicipalCheckup_9P560000000000011)
    * ^short = "問診結果セクションに含まれる 子宮頸がん検診の過去の受診歴 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
  * entry[9P561000000000011] only Reference(JP_Observation_eMunicipalCheckup_9P561000000000011)
    * ^short = "問診結果セクションに含まれる 子宮頸がん検診時の子宮頸がんに係る症状の有無 をあらわすObservationリソースへの参照。"
    * reference 1..1
      * ^short = "参照先のリソースのfullUrl要素に指定されるUUID。"
