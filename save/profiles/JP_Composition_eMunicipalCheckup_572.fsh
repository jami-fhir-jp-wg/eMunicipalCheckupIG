Profile:        JP_Composition_eMunicipalCheckup_572
Parent:         Composition
Id:             JP-Composition-eMunicipalCheckup-572
//Title:          "自治体検診結果報告書　Compositionリソース　文書構成情報"
Description:    "自治体検診結果報告書　Compositionリソース　文書構成情報(骨粗鬆症検診精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Composition_eMunicipalCheckup_572"
* ^status = #draft
