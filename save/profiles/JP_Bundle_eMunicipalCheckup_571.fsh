Profile:        JP_Bundle_eMunicipalCheckup_571
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-571
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(骨粗鬆症検診一次)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_571"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_571
    * ^short = "文書構成情報(骨粗鬆症検診一次)"
