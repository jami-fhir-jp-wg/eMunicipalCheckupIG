Profile:        JP_Composition_eMunicipalCheckup_541
Parent:         Composition
Id:             JP-Composition-eMunicipalCheckup-541
//Title:          "自治体検診結果報告書　Compositionリソース　文書構成情報"
Description:    "自治体検診結果報告書　Compositionリソース　文書構成情報(子宮頸がん一次検診)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Composition_eMunicipalCheckup_541"
* ^status = #draft
