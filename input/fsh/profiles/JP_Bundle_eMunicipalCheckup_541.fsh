Profile:        JP_Bundle_eMunicipalCheckup_541
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-541
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(子宮頸がん一次検診)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_541"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_541
    * ^short = "文書構成情報(子宮頸がん一次検診)"
