Profile:        JP_Bundle_eMunicipalCheckup_542
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-542
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(子宮頸がん精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_542"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_542
    * ^short = "文書構成情報(子宮頸がん精密検査)"
