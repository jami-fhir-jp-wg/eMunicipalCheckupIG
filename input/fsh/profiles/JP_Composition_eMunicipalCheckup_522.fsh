Profile:        JP_Composition_eMunicipalCheckup_522
Parent:         Composition
Id:             JP-Composition-eMunicipalCheckup-522
//Title:          "自治体検診結果報告書　Compositionリソース　文書構成情報"
Description:    "自治体検診結果報告書　Compositionリソース　文書構成情報(乳がん精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Composition_eMunicipalCheckup_522"
* ^status = #draft
