Profile:        JP_Bundle_eMunicipalCheckup_581
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-581
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(歯周疾患一次検診)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_581"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_581
    * ^short = "文書構成情報(歯周疾患一次検診)"
