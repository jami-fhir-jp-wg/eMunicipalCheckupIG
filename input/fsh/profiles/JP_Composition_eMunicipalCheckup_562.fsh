Profile:        JP_Composition_eMunicipalCheckup_562
Parent:         Composition
Id:             JP-Composition-eMunicipalCheckup-562
//Title:          "自治体検診結果報告書　Compositionリソース　文書構成情報"
Description:    "自治体検診結果報告書　Compositionリソース　文書構成情報(肝炎ウイルス精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Composition_eMunicipalCheckup_562"
* ^status = #draft
