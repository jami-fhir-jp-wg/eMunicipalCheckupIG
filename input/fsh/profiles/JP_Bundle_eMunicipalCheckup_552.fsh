Profile:        JP_Bundle_eMunicipalCheckup_552
Parent:         Bundle
Id:             JP-Bundle-eMunicipalCheckup-552
Description:    "自治体検診結果報告書　Bundleリソース　文書情報(大腸がん精密検査)"
* ^url = "http://jpfhir.jp/fhir/eMunicipalCheckup/StructureDefinition/JP_Bundle_eMunicipalCheckup_552"
* ^status = #draft
...
* entry[composition]
  ...
  * resource 1..1 MS
  * resource only JP_Composition_eMunicipalCheckup_552
    * ^short = "文書構成情報(大腸がん精密検査)"
