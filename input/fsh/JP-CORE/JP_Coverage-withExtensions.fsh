...
// extension 参照宣言
* extension contains JP_Coverage_InsuredPersonSymbol named InsuredPersonSymbol 0..1
* extension contains JP_Coverage_InsuredPersonNumber named InsuredPersonNumber 0..1
* extension contains JP_Coverage_InsuredPersonSubNumber named InsuredPersonSubNumber 0..1
//
...
* extension ^min = 0
* extension[InsuredPersonSymbol] only JP_Coverage_InsuredPersonSymbol
* extension[InsuredPersonSymbol] ^sliceName = "InsuredPersonSymbol"
...
* extension[InsuredPersonNumber] only JP_Coverage_InsuredPersonNumber
* extension[InsuredPersonNumber] ^sliceName = "InsuredPersonNumber"
...
* extension[InsuredPersonSubNumber] only JP_Coverage_InsuredPersonSubNumber
* extension[InsuredPersonSubNumber] ^sliceName = "InsuredPersonSubNumber"
